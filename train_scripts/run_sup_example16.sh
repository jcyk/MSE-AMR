...
OUTPUT_DIR=result/16my-sup-simcse-bert-base-uncased.${seed}
NUM_GPU=4
...
python3 evaluation.py --model_name_or_path ${OUTPUT_DIR} --task_set sts --pooler simcse_sup > ${OUTPUT_DIR}/sts.log
done
